    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolesWithinGroup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppUserId = table.Column<Guid>(type: "uuid", nullable: false),
                    Message = table.Column<string>(type: "text", nullable: true),
                    ReminderAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Remainders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Remainders_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    AvailabilityTimes = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeetingTimes = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudyGroups_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    StudyGroupsId = table.Column<Guid>(type: "uuid", nullable: false),
                    SenderUserId = table.Column<Guid>(type: "uuid", nullable: false),
                    RequestStatus = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupJoinRequests_AspNetUsers_SenderUserId",
                        column: x => x.SenderUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupJoinRequests_StudyGroups_StudyGroupsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupMeetings_StudyGroups_StudyGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleWithinGroupId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserStudyGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserStudyGroups_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserStudyGroups_RolesWithinGroup_RoleWithinGroupId",
                        column: x => x.RoleWithinGroupId,
                        principalTable: "RolesWithinGroup",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserStudyGroups_StudyGroups_StudyGroupsId",
                        column: x => x.StudyGroupsId,
                        principalTable: "StudyGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupJoinRequests_SenderUserId",
                table: "GroupJoinRequests",
                column: "SenderUserId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupJoinRequests_StudyGroupsId",
                table: "GroupJoinRequests",
                column: "StudyGroupsId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupMeetings_StudyGroupId",
                table: "GroupMeetings",
                column: "StudyGroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Remainders_AppUserId",
                table: "Remainders",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_StudyGroups_AppUserId",
                table: "StudyGroups",
                column: "AppUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserStudyGroups_AppUserId",
                table: "UserStudyGroups",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserStudyGroups_RoleWithinGroupId",
                table: "UserStudyGroups",
                column: "RoleWithinGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_UserStudyGroups_StudyGroupsId",
                table: "UserStudyGroups",
                column: "StudyGroupsId");
        }
